"""Resource method: GetPriceTicksBetweenDates."""
...
class _GetPriceTicksBetweenDatesMixin(BaseResource):
    async def get_price_ticks_between_dates(
        self,
        market_id: str,
        ...
        *,
        ...
        in ascending order between fromTimestampUTC and toTimestampUTC . The length of
        time that elapses between each tick is usually different.
        """
        return await _ep.aget_price_ticks_between_dates(
            self._ctx,
            market_id,
            from_time_stamp_utc,
            to_timestamp_utc,
