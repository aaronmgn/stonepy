...
class NewStopLimitOrderRequestDTO(RequestModel):
    ...
    def __init__(
        ...
        *,
        ...
        IfDone: list[RequestApiIfDoneDTOv2] | None = ...,
        OcoOrder: NewStopLimitOrderRequestDTO | None = ...,
        Applicability: str,
        ExpiryDateTimeUTC: StoneXDateTime,
        Guaranteed: bool,
        TriggerPrice: Decimal,
        Reference: str,
        AllocationProfileId: int,
        OrderReference: str,
        Source: str,
    ) -> None: ...
    @overload
    def __init__(
        ...
        *,
        ...
        auto_rollover: bool,
        direction: str,
        position_method_id: int,
        quantity: Decimal,
        bid_price: Decimal,
        offer_price: Decimal,
        audit_id: str,
        trading_account_id: int,
        if_done: list[RequestApiIfDoneDTOv2] | None = ...,
        oco_order: NewStopLimitOrderRequestDTO | None = ...,
        applicability: str,
        expiry_date_time_utc: StoneXDateTime,
        guaranteed: bool,
        trigger_price: Decimal,
        reference: str,
        allocation_profile_id: int,
        order_reference: str,
        source: str,
    ) -> None: ...
