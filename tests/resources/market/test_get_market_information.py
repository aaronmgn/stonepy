...
def test_get_market_information_returns_response() -> None:
    route = respx.get("https://api.example/market/v2/market/x/information").mock(
    ...
    try:
        ...
        assert isinstance(resp, GetMarketInformationResponseDTO)
        assert route.called
        assert route.calls[0].request.method == "GET"
        assert route.calls[0].request.url.path == "/market/v2/market/x/information"
