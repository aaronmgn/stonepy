...
| `user_agent` | `str` | `"stonepy/<version>"` | User-Agent header. Defaults to `stonepy/` plus the installed package version (falling back to `0.2.0` if the version cannot be resolved). |
